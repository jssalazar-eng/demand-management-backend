...
public class GetAllDemandsHandlerTests
{
    ...
    private readonly GetAllDemandsHandler _handler;

    public GetAllDemandsHandlerTests()
    {
        ...
        _handler = new GetAllDemandsHandler(_mockUow.Object);
    }

    [Fact]
    public async Task Handle_ShouldReturnAllDemands_WhenDemandsExist()
    {
        // Arrange
        ...
        _mockDemandRepo.Setup(r => r.GetAllAsync(It.IsAny<CancellationToken>()))
        ...
        result.First().Title.Should().Be("Demand 1");
    }

    [Fact]
    public async Task Handle_ShouldReturnEmptyList_WhenNoDemandsExist()
    {
        // Arrange
        _mockDemandRepo.Setup(r => r.GetAllAsync(It.IsAny<CancellationToken>()))
